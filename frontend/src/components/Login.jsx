        ...
        <div className="flex flex-col items-center justify-center min-h-[60vh] p-4 text-white">
            ...
            >
                <div className="mb-8 text-center">
                    ...
                    <p className="text-gray-400 text-sm">Wait for retinal scan... (Just kidding, enter password)</p>
                </div>
                ...
                <div className="mt-6 text-center text-sm text-gray-400">
                    ...
                    <button onClick={onSwitchToRegister} className="text-cyan-400 hover:text-cyan-300 underline font-medium">
                        Request Access
                    </button>
                </div>
            </motion.div>
